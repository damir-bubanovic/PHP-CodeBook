...
!!SQL - CONNECTING TO AN SQL DATABASE!!

> want access to a SQL database to store or retrieve information
> Create a new PDO object with the appropriate connection string
	>> code below - PDO object creation for a few different kinds of databases
